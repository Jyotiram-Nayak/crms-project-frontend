                      ...
                      {role === "Student" && (
                        <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {/* <Link
                              href="#"
                              // className="bg-primary rounded font-medium gap-2.5 hover:bg-opacity-90 inline-flex items-center px-2 py-2 text-white"
                              className="bg-gradient-to-r from-blue-500 to-purple-600 rounded font-medium gap-2.5 hover:bg-opacity-90 inline-flex items-center px-2 py-2 text-white"
                              onClick={() => apply(job.jobId)}
                            >
                              Apply Now
                            </Link> */}
                            <ApplyButton path="/company/jobposting" jobId={job.jobId} />
                          </p>
                        </td>
                      )}
                    </tr>
